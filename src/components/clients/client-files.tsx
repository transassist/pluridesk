...
export function ClientFiles({ clientId }: ClientFilesProps) {
    ...
    const handleDownload = async (fileId: string, fileName: string) => {
        try {
            ...
            link.href = url;
            link.download = fileName; // This might not work for cross-origin but worth trying
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <div>
                    ...
                    <CardDescription>Manage documents, contracts, and style guides</CardDescription>
                </div>
                <div>
                    <input
                        type="file"
